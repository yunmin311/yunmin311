...
<a href="https://github.com/yunmin311/pixel-panels"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-pixel-panels-m.svg"><img alt="Pixel Panels — The components this page is built from, lifted out and documented. One 2px grid, one embedded bitmap face, and the four rules that keep fourteen separate parts reading as a single instrument. JavaScript, SVG, Zero-dependency, MIT." title="Open pixel-panels on GitHub" src="assets/generated/work-pixel-panels.svg"></picture></a>
...
<a href="https://github.com/yunmin311/quiet-shelf-obsidian"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-quiet-shelf-obsidian-m.svg"><img alt="quiet-shelf-obsidian — Hide archived and index notes from the Obsidian file explorer without moving them, and focus the tree on one set of folders at a time. JavaScript, file-explorer, focus-mode, markdown." title="Open quiet-shelf-obsidian on GitHub" src="assets/generated/work-quiet-shelf-obsidian.svg"></picture></a>
<!-- SELECTED_WORK_END -->

...
<a href="https://github.com/yunmin311/window-annotator"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-window-annotator-m.svg"><img alt="Window Annotator — Drawing on the thing you are looking at should not depend on the app supporting it. Hand-drawn marks pin to any Windows window and follow it as it moves, resizes and scrolls. Electron, JavaScript, koffi FFI, Windows." title="Open window-annotator on GitHub" src="assets/generated/work-window-annotator.svg"></picture></a>

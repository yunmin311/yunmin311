...
<!-- SELECTED_WORK_START — rewritten by scripts/build.mjs on every run. Do not
     ...
     decided by scripts/lib/projects.mjs from the pool in scripts/config.json.
...
<a href="https://github.com/yunmin311/yunmin-workbench"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-yunmin-workbench-m.svg"><img alt="Yunmin Workbench — A clean-room desktop workbench for running Claude Code and Codex side by side — rebuilt from a frozen baseline rather than patched forward, because a tool you depend on has to be explainable. TypeScript, Electron, Local-first, Windows." title="Open yunmin-workbench on GitHub" src="assets/generated/work-yunmin-workbench.svg"></picture></a>
<a href="https://github.com/yunmin311/dsh-universal-palette"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-dsh-universal-palette-m.svg"><img alt="DSH Universal Palette — Three products with three different colour systems, and a designer retyping hex codes between them. One plugin turns whatever you are looking at into the palette you actually use. TypeScript, Figma Plugin, Design Tokens." title="Open dsh-universal-palette on GitHub" src="assets/generated/work-dsh-universal-palette.svg"></picture></a>
<a href="https://github.com/yunmin311/work-capsule"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-work-capsule-m.svg"><img alt="Work Capsule — Keeping work in sync across machines should not risk it. One click pulls, optionally commits and pushes every folder you chose — fast-forward only, never rewriting history. Rust, egui, Git, Windows." title="Open work-capsule on GitHub" src="assets/generated/work-work-capsule.svg"></picture></a>
<a href="https://github.com/yunmin311/zheng-tally-obsidian"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-zheng-tally-obsidian-m.svg"><img alt="Zheng Tally for Obsidian — Counting things in a note should not mean leaving the note. Tally marks you can strike through inline, with the running total kept where the writing happens. TypeScript, Obsidian, CodeMirror 6." title="Open zheng-tally-obsidian on GitHub" src="assets/generated/work-zheng-tally-obsidian.svg"></picture></a>
<a href="https://github.com/yunmin311/context-distiller"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-context-distiller-m.svg"><img alt="Context Distiller — Choosing what an AI gets to see is the step nobody built a tool for. A workspace for picking, grouping and compiling that context into one plain-text message — locally, and never sent anywhere. TypeScript, React 19, WXT, Manifest V3." title="Open context-distiller on GitHub" src="assets/generated/work-context-distiller.svg"></picture></a>
<a href="https://github.com/yunmin311/governance-framework"><picture><source media="(max-width: 500px)" srcset="assets/generated/work-governance-framework-m.svg"><img alt="Governance Framework — Run several AI agents and they forget, contradict each other, and disagree about which file is real. Pinning the facts into files fixes what a smarter model cannot. Markdown, YAML, Python, Validators." title="Open governance-framework on GitHub" src="assets/generated/work-governance-framework.svg"></picture></a>
<!-- SELECTED_WORK_END -->
